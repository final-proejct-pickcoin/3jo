...
const toast = (props) => {
  ...
  // 공통 dispatch 헬퍼
  const createDispatch = (type, payload = {}) => dispatch({
    type,
    ...payload,
  ...
  const update = (updateProps) => createDispatch(ACTION_TYPES.UPDATE_TOAST, updateProps);
  const dismiss = () => createDispatch(ACTION_TYPES.DISMISS_TOAST);
